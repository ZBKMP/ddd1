...
DB_CONFIG = {
    ...
    'user': 'root',
    'password': 'root',
    'database': 'd_graph_rag_origin_data'
}
...
def main():
    ...
    if conn:
        try:
            ...
            generate_customers(conn, 102) # 100个客户
            generate_products(conn, 101)  # 100个产品
            generate_orders(conn, 998)   # 1000个订单
            generate_reviews(conn, 1314)   # 5000条评论
