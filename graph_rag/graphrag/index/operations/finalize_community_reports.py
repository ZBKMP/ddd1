...
def finalize_community_reports(
    ...
    if reports.empty or "community" not in reports.columns:
        msg = (
            "No community reports were generated. This usually means the LLM returned "
            "invalid or empty JSON. Check your API key, api_base, model name, and that "
            "the endpoint supports JSON output (model_supports_json)."
        )
