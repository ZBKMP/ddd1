# 非分割类型的文档转换器 问答转换器  翻译转换器
import dotenv
from langchain_community.document_transformers import DoctranQATransformer, DoctranTextTranslator
...
# 3.输出内容 经过文档转换之后 会增加一个metadata信息 questions_and_answers
