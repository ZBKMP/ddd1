...
const getResponseErrorMessage = (json: {
  message?: string
  code?: string
  data?: Record<string, string[]>
}) => {
  if (json.message) return json.message
  if (json.code === httpCode.validateError && json.data) {
    const firstError = Object.values(json.data).flat()[0]
      ...
      globalThis
        ...
        .then(async (res) => {
          ...
          if (json.code === httpCode.success) {
            ...
            const message = getResponseErrorMessage(json)
