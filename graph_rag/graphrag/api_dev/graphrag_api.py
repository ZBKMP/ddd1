...
# =========================================================================
# 路径锁定（与 graphrag_prompt_tune.py / graphrag_indexing.py 相同）
# =========================================================================
...
STATIC_DIR = API_DEV_ROOT / "static"
HOST = "127.0.0.1"
PORT = 9999
...
logger = setup_logging(
    LOG_DIR_PATH,
    log_file="graphrag_api.log",
    logger_name="dev-graphrag-api",
)
...
def start():
    ...
    logger.info("启动 API 服务 http://%s:%s", HOST, PORT)
    logger.info("查询界面: http://%s:%s/static/index.html", HOST, PORT)
